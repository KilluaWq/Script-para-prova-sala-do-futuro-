...
O InfinityCode éatalho para gabrito 🎯 Perfeito para estudantes!
...
💾 Salve o favorito
🌐 Navegue para qualquer página e clique no favorito 🌌 InfinityCode
🎮 Desfrute da animação hacker e clique no botão flutuante
📋 Cole seu JSON e processe o gabarito!
...
🛡️ Habilite colagem - Digite: allow pasting e pressione Enter
📋 Cole este código:
javascript:(function() {
...
👨‍💻 Autores
@trampos - Desenvolvedor Principal 💻
@bakai - Criador & Mantenedor 🚀
📄 Licença e Uso
MIT License © 2025
...
🎉 Comece Agora Mesmo!
🚀 Via Bookmarklet:
Crie o favorito com o código
Clique em qualquer página
Cole o JSON e comece a estudar!
⚡ Via Console:
Abra o DevTools
Digite allow pasting no console
Cole o código no console
Use o botão flutuante e seja feliz!
💎 Dica Pro ⭐
...
✅ Via Bookmarklet:
Crie um favorito com o código acima.
Acesse qualquer página e clique no favorito.
Cole o JSON no painel e comece a usar.
✅ Via Console:
Abra o DevTools (F12).
Digite allow pasting no console.
Cole e execute o fetch no console.
Use o botão flutuante para abrir o painel e inserir o gabarito.
